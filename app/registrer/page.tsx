    ...
    return (
      <main className="flex min-h-screen items-center justify-center">
        <div className="flex flex-col items-center gap-6 text-center max-w-sm">
          ...
          <p className="text-zinc-500">Vi har sendt en bekreftelseslenke til e-posten din. Klikk på lenken for å aktivere kontoen.</p>
          <Link href="/login" className="bg-dark-green text-white font-semibold py-3 px-8 rounded-xl hover:opacity-90 transition-all">
            Gå til innlogging
          </Link>
        </div>
      </main>
