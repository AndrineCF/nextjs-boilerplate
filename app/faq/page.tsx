...
import { faqData, kategorier } from "@/lib/data/faqData";
  ...
  return (
    <main className="w-full">
      <Hero
        ...
        description="Her finner du svar på de vanligste spørsmålene om GrøntTak og grønne tak i Trondheim. Finner du ikke svaret du leter etter? Ta gjerne kontakt med oss."
